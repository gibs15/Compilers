...
{
       0,     0,     3,     5,     7,    11,    14,    18,    25,    34,
      35,    37,    39,    42,    46,    49,    60,    65,    72,    73,
      75,    77,    81,    85,    89,    96,   105,   110,   118,   124,
     128,   131,   137,   140,   143,   147,   151,   155,   159,   162,
     166,   170,   174,   177,   181,   183,   185,   187,   189,   196,
     198,   201,   207,   215,   221,   229,   233,   237,   238,   240,
     242,   246,   249,   253,   256
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      43,    23,    17,    55,    38,    -1,    56,    -1,    57,    56,
      -1,    24,    43,    23,    44,    58,    -1,    24,    43,    23,
      25,    55,    44,    58,    -1,    24,    43,    23,     7,    55,
      -1,    24,    43,    23,    25,    55,     7,    55,    -1,     1,
      44,    58,    -1,     1,     7,    55,    -1,    -1,    60,    -1,
      55,    -1,    60,    44,    55,    -1,    55,    38,    -1,    61,
      55,    38,    -1,     1,    38,    -1,    61,     1,    38,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   124,   124,   128,   131,   134,   137,   143,   146,   152,
     153,   161,   163,   165,   167,   172,   174,   176,   182,   183,
     188,   190,   195,   200,   202,   204,   206,   208,   210,   212,
     214,   216,   218,   220,   222,   224,   226,   228,   230,   232,
     234,   236,   238,   240,   242,   244,   246,   248,   253,   258,
     260,   265,   267,   269,   271,   273,   275,   281,   282,   287,
     289,   294,   296,   298,   300
};
#endif
...
static const char *const yytname[] =
{
  ...
  "formal_list", "formal", "expr", "case_st", "case_list", "let_expr",
  "dummy_expr_list", "expr_list", "expr_list_semi", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 132 "cool.y"
    { (yyval.classes) = single_Classes((yyvsp[(3) - (3)].class_));
    parse_results = (yyval.classes); }
    break;
...
/* Line 1455 of yacc.c  */
#line 138 "cool.y"
    { (yyval.classes) = (yyvsp[(1) - (3)].classes);
    parse_results = (yyval.classes); }
    break;
